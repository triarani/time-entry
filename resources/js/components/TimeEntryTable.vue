<template>
  <div class="w-full">
        ...
        <tr v-for="(row, i) in rows" :key="i" class="border-t">
          ...
          <td class="p-2 border">
            <div class="flex items-center justify-center gap-2">
              <button type="button" @click="duplicateRow(i)" class="px-3 py-1.5 bg-linear-to-r from-gray-500 to-gray-600 text-white rounded-lg hover:from-gray-600 hover:to-gray-700 shadow-md transition-all duration-200 text-sm" title="Duplicate row">
                ⧉
              </button>
              <button v-if="i > 0" type="button" @click="deleteRow(i)" class="px-3 py-1.5 bg-linear-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 shadow-md transition-all duration-200 text-sm" title="Delete row">
                ✕
              </button>
            </div>
          </td>
    ...
    <div class="mt-4 flex items-center justify-end gap-4">
      ...
      <button @click="submitAll" :disabled="loading" class="px-6 py-2.5 bg-linear-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-800 hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
